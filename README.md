...
- Test code for Stata (any version) that works, deep path (`main.do` is in a long non-root directory): <https://github.com/SIVACOR/sivacor-test-stata/tree/longpath>
